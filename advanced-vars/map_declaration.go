...
func main() {
	...
	map7 := make(map[string]map[string]Fruit)
	map7["fruit"] = map[string]Fruit{"apple": {Price: 5, Color: "green"}, "banana": {Price: 7, Color: "yellow"}}
	map7["vegetable"] = map[string]Fruit{"carrot": {Price: 3, Color: "orange"}, "peas": {Price: 2, Color: "green"}}
	fmt.Println("Nested map:", map7)
}